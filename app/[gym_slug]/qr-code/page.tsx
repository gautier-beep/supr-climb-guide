...
export default function QRCodePage() {
  ...
  return (
    <div className="min-h-screen bg-supr-cream py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-black mb-2">QR Code {gym.name}</h1>
            <p className="text-black">Téléchargez et affichez sur votre Beginner Wall</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <h3 className="font-semibold text-black mb-3">📋 Instructions d&apos;utilisation</h3>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl">
            ...
            <code className="text-xs text-black break-all">{appUrl}</code>
          </div>

          {/* Footer */}
          <div className="mt-8 pt-6 border-t text-center">
            <p className="text-sm text-black">
              Powered by <span className="font-bold text-supr-mint-dark">SUPR Climbing</span>
            </p>
          </div>
        </div>
      </div>
